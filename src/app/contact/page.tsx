    ...
    <section className="max-w-3xl mx-auto py-16 px-4 ">
      ...
      <div className="mt-10 grid gap-8 text-[18px] text-[#010d3e] place-items-center">
        <div className="p-10 border border-[#222222]/10 rounded-3xl shadow-[0_7px_14px_#eaeaea] w-full mx-auto 
          ...
          <p>Email: <a href="mailto:david@tgandtechnologies.com" className="underline hover:text-black">david@tgandtechnologies.com</a></p>
        ...
        <div className="p-10 border border-[#222222]/10 rounded-3xl shadow-[0_7px_14px_#eaeaea] w-full mx-auto 
          ...
          <p>Email: <a href="mailto:support@tgandtechnologies.com" className="underline hover:text-black">support@tgandtechnologies.com</a></p>
